...
def apply_re_targets(re_targets, remove_nodes, oar_df, 
                     fuel_set, annual_demand_df, 
    ...
    for target, target_params in re_targets.items():
        ...
        first_year_dict[target] = target_params[1]
        final_year_dict[target] = target_params[2]
        value_dict[target] = target_params[3]
